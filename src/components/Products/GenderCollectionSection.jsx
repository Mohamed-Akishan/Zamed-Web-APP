...
const GenderCollectionSection = () => {
    ...
    const loadSettings = () => {
        try {
            ...
            // Also check site_images for fallback
            const siteImages = JSON.parse(localStorage.getItem('site_images') || '{}');
            
            setSettings({
                genderMenBackground: siteInfo.genderMenBackground || siteImages.genderMenBackground || siteSettings.genderMenBackground || null,
                genderWomenBackground: siteInfo.genderWomenBackground || siteImages.genderWomenBackground || siteSettings.genderWomenBackground || null,
                genderKidsBackground: siteInfo.genderKidsBackground || siteImages.genderKidsBackground || siteSettings.genderKidsBackground || null,
                    ...
                    {collections.map((collection, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    {/* Background - Always render fallback gradient as base */}
                                    <div 
                                        className="absolute inset-0 w-full h-full transition-transform duration-700 group-hover:scale-110"
                                        style={{ background: collection.gradient }}
                                    />

                                    {/* Background Image - Only if available and no error */}
                                    ...
                                    {/* If fallback, add a stronger overlay for text readability */}
                                    {showFallback && (
                                        <div 
                                            className="absolute inset-0"
                                            style={{
